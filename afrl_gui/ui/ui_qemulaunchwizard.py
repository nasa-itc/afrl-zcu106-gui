...
class Ui_qemuLaunchWizard(object):
    def setupUi(self, qemuLaunchWizard):
        ...
        self.subnetMaskLabel.setGeometry(QRect(10, 130, 111, 30))
        ...
        self.subnetMaskLineEdit.setGeometry(QRect(130, 130, 171, 30))
        self.gatewayLabel = QLabel(self.qemuLaunchWizardNetworkPage)
        self.gatewayLabel.setObjectName(u"gatewayLabel")
        self.gatewayLabel.setGeometry(QRect(10, 90, 111, 30))
        self.gatewayLineEdit = QLineEdit(self.qemuLaunchWizardNetworkPage)
        self.gatewayLineEdit.setObjectName(u"gatewayLineEdit")
        self.gatewayLineEdit.setGeometry(QRect(130, 90, 171, 30))
